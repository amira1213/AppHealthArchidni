...
public class HeartBeatActivity extends AppCompatActivity implements SurfaceHolder.Callback {
    ...
    private Camera.PreviewCallback previewCallback = new Camera.PreviewCallback() {
        ...
        public void onPreviewFrame(byte[] data, Camera camera) {
            ...
            if (totalTimeInSecs >= 10) {
                ...
                TextView hearBeatText = (TextView) HeartBeatActivity.this.findViewById(R.id.text_heart_beat);
                hearBeatText.setText("Résultat : "+beatsAvg+" Bpm");
                ...
                editor.commit();*/
                //Toast.makeText(this,String.valueOf(beatsAvg),Toast.LENGTH_LONG).show();
